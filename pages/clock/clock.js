Page({
  ...
  but:function(e){
    ...
    function drawInnerCircle() {    // 绘制固定内圈圆
      ...
      context.moveTo(200, 100);    // moveTo-把路径移动到画布中的制定点，不创建线条；参数-moveTo(目标位置的x坐标，目标位置的y坐标)
      context.arc(100, 100, 100, 0, 2 * Math.PI, true);  // arc-创建一条弧线；参数-arc(圆心x坐标，圆心y坐标，圆半径，起始弧度，终止弧度，弧度方向是否是逆时针)
    ...
    function drawOutCircle(n) {    // 绘制倒计时外圈圆
      ...
      context.arc(100, 100, 100, 0, -Math.PI * 2 / 120 * n, true)
      context.stroke()
      context.restore();
    }
